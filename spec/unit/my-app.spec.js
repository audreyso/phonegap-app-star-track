describe('my-app.js', function() {
  ...
  // Complete these tests below for durationFromMsHelper func
  xdescribe('durationFromMsHelper function', function() {
    it('durationFromMsHelper', function() {
      expect(durationFromMsHelper(200000)).toEqual();
    });
    it('durationFromMsHelper', function() {
      expect(durationFromMsHelper('Hello')).toEqual();
    });
  });
});
